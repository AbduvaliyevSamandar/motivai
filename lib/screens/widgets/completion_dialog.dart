...
class CompletionDialog extends StatefulWidget {
  ...
  const CompletionDialog(
      {super.key, required this.result, required this.taskTitle});

  @override
  State<CompletionDialog> createState() => _State();
}

class _State extends State<CompletionDialog>
  ...
  Widget build(BuildContext context) {
    ...
    final newAchievs = (r['new_achievements'] as List?) ?? [];
        ...
        child: ScaleTransition(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: C.primary.withOpacity(0.4), width: 1.5),
              boxShadow: [
                BoxShadow(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  widget.taskTitle,
                  style:
                      const TextStyle(color: C.sub, fontSize: 13),
                ...
                if (newAchievs.isNotEmpty) ...[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        const Text('🏆 Yangi yutuqlar!',
                            style: TextStyle(
                                color: C.gold,
                                fontWeight: FontWeight.bold)),
                        const SizedBox(height: 6),
                        ...newAchievs.map((a) => Text(
                              '${a['emoji'] ?? '🎖'} ${a['name'] ?? a.toString()}',
                              style: const TextStyle(
